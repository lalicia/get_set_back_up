        ...
        <>
            ...
            <div className="about-container">
                <div className="about-contents max-w-[80%] m-auto">
                    ...
                    <p className="text-lg font-medium text-center">This is how I handle my extreme fear of my laptop dying - by planning for the eventuality and providing myself with a roadmap.</p>
                    ...
                    <p className="text-lg font-medium text-center">That's all there is to this site. I wanted something for myself, but I figured it might help other people too, so I put everything together and made it a bit pretty. This is by NO means exhaustive but I feel it's enough of a safety net and a decent place to start.</p>
